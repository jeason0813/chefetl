...
{
    /// <summary>
    /// Summary description for MyMethod2Test1
    /// </summary>
    [TestClass]
    public class MyMethod2Test1
    {
        public MyMethod2Test1()
        {
            //
        ...
        [TestMethod]
        public void CreateProjectAndDeployTest1()
        {
            ...
            CatalogFolder catalogFolder = catalog.Folders["CHEFFolder"];
            ...
            Assert.IsNotNull(catalogFolder.Projects[Program_Accessor.processID + "_" + Program_Accessor.processName]);
        }
    }
}
