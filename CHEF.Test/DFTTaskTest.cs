...
{
    /// <summary>
    /// Summary description for DFTTaskTest
    /// </summary>
    [TestClass]
    public class DFTTaskTest
    {
        public DFTTaskTest()
        {
            //
        ...
        public void TestDataFlowTask()
        {
            ...
            cmd.CommandText = "INSERT INTO [CHEF].[Metadata] VALUES "
                                                ...
                                                + "     <Process ID=\"9000\" Name=\"DemoDFT\" DefaultAllowTruncate=\"False\" VerboseLogging=\"False\" ExecuteExistingPackage=\"False\" >"
                                                + "         <ConnectionSet>"
                                                + "             <SQLConnection key=\"SQLConnection\" ServerName=\"(local)\" DatabaseName=\"AdventureWorks2012\" />"
                                                + "         </ConnectionSet>"
                                                + "         <Step ID=\"9010\" Name=\"Data Flow Test\" TypeID=\"1\" TypeName=\"Staging\">"
            ...
            cmd.Parameters.AddWithValue("@ProcessID", 9000);
            cmd.Parameters.AddWithValue("@StartStepID", 9010);
            ...
            cmd.CommandText = "DELETE FROM [CHEF].[RequestQueue] WHERE [QueueID] = (SELECT MAX(QueueID) FROM [CHEF].[RequestQueue] WHERE [ProcessID] = 9000)";
            cmd.ExecuteNonQuery();
            ...
            ProjectInfo projectInfo = integrationServices.Catalogs["SSISDB"].Folders["CHEFFolder"].Projects["9000_DFTTaskTest"];
